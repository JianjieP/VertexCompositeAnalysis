...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("root://xrootd-cms.infn.it///store/user/anstahll/CERN/PbPb2024/MC/2026_04_14/STARLIGHT/STARLIGHT_5p36TeV_2024Run3/coh_phi_dika_STARLIGHT_5p36TeV_2024Run3_RECO_2026_04_14/260414_102007/0000/STARLIGHT_coh_phi_dika_RECO_1.root"),
)
process.maxEvents = cms.untracked.PSet(input = cms.untracked.int32(-1))

# Set the global tag
process.load('Configuration.StandardSequences.FrontierConditions_GlobalTag_cff')
process.GlobalTag.globaltag = cms.string('141X_mcRun3_2024_realistic_HI_v16')
