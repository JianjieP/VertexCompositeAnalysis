...
void sampleAna_chaining_by_i(Int_t i) {
    ...
    TString outDir = "/eos/user/j/jianjie/fourpi/HIRun2023A-14Feb2025-v1_FourPi_0520";
    TString baseDir = Form("/eos/user/j/jianjie/fourpi/HIForward%d/HIForward%d/HIForward%d_HIRun2023A-14Feb2025-v1_FourPi_0520", i, i, i);
