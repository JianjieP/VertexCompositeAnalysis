...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("root://xrootd-cms.infn.it//store/hidata/HIRun2025A/HIForward0/MINIAOD/PromptReco-v1/000/398/954/00000/8fb3285b-e7b0-4ddb-8994-b4b1fd1804da.root"),
)
...
process.Flag_hfPosFilterNTh9p3 = cms.Path(process.eventFilter * process.hfPosFilterNTh9p3_seq)
process.Flag_hfNegFilterNTh8p6 = cms.Path(process.eventFilter * process.hfNegFilterNTh8p6_seq)

eventFilterPaths = [ process.Flag_colEvtSel , process.Flag_clustercomp , process.Flag_primaryVertexFilter, process.Flag_hfPosFilterNTh9p3, process.Flag_hfNegFilterNTh8p6 ]
